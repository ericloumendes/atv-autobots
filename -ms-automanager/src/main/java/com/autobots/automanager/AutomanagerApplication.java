...
public class AutomanagerApplication implements CommandLineRunner {
    ...
    @Autowired
    private PasswordEncoder passwordEncoder; // Corrigido aqui
    ...
    public void run(String... args) throws Exception {
        String nomeUsuarioCliente = "dompedrocliente";

        Optional<CredencialUsuarioSenha> credencialExistente = repositorioCredencial.findByNomeUsuario(nomeUsuarioCliente);

        if (credencialExistente.isPresent()) {
            System.out.println("Usuário '" + nomeUsuarioCliente + "' já existe. Ignorando criação dos dados iniciais.");
            return;
        }
        ...
        funcionario.setPerfil(Perfil.ROLE_GERENTE);
        ...
        fornecedor.setPerfil(Perfil.ROLE_GERENTE);
        ...
        credencialCliente.setNomeUsuario(nomeUsuarioCliente);
