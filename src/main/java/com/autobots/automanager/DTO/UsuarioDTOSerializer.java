...
public class UsuarioDTOSerializer extends JsonSerializer<UsuarioDTO> {
    ...
    public void serialize(UsuarioDTO usuarioDTO, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        if (usuarioDTO.getPerfis() != null && !usuarioDTO.getPerfis().isEmpty()) {
            gen.writeObjectField("perfis", usuarioDTO.getPerfis());
        }
        ...
        if (usuarioDTO.getCredenciais() != null && !usuarioDTO.getCredenciais().isEmpty()) {
            gen.writeObjectField("credenciais", usuarioDTO.getCredenciais());
        }
